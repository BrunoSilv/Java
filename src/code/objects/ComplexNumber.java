...
public class ComplexNumber {
    ...
    /**
     * Complex Number Constructor. This will create a complex number representing zero.
     */
    ...
    /**
     * ComplexNumber constructor.  Creates a complex number representing provided real value
     * and imaginary value.
     * @param real          Real portion of complex number
     * @param imaginary     Imaginary portion of complex number
     */
     ...
     * @param cn    Complex number to be added
     */
     ...
     * @param cn    Complex number to be subtracted
     */
     ...
     * @param cn    Complex number to be multiplied by.
     */
    ...
    /**
     * Divides the complex number by the denominator (divisor) provided in this method
     * @param denominator  Divisor complex number.
     */
    ...
    /**
     * Proivdes String representation of the complex number. This representation
     * is helpful in printing on to the screen.
     ...
     * @param cn1   Complex Number 1
     * @param cn2   Complex Number 2
